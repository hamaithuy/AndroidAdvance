...
import com.example.banhang.Model.Products;
import com.example.banhang.Model.User;
import com.example.banhang.Prevalent.Prevalent;
import com.example.banhang.ViewHolder.ProductViewHolder;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SDT = headerView.findViewById(R.id.navheader_SDT);
        SDT.setText(CurrentUser.CurrentUser.getPhone());
        ...
        FirebaseRecyclerAdapter<Products, ProductViewHolder> adapter =
                new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull Products products) {
                        ...
                        holder.motaSP.setText(products.getMota());
                        holder.giaSP.setText(products.getGia()+"đ");
                        Picasso.get().load(products.getImage()).into(holder.anhSP);
