...
public class Room {
    ...
    public Room(String title, double price, String address, String phoneNumber, float acreage, Date timePost, String description, Boolean wifi, Boolean ownWc, Boolean keepCar, Boolean freedom, Boolean kitchen, Boolean airMachine, Boolean fridge, Boolean washMachine, int kindPost, int kindRoom, String boss, String imageUrl, int position, String key, Boolean accept) {
        this.title = title;
        this.price = price;
