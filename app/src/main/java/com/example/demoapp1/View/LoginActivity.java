...
import com.example.demoapp1.Model.User;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void comeToPostedRoomActivity() {
        Intent intent= new Intent(this,com.example.demoapp1.View.PostedActivity.class);
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (acct != null) {
           ...
           // Toast.makeText(this, "ID Firebase:"+persionIdFirebase+"----ID CurrentGoogle:"+personId, Toast.LENGTH_SHORT).show();
            ...
            intentAccount.putExtra("EMAIL",personEmail);
