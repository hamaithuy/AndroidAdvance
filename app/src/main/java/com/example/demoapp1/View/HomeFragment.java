...
import com.example.demoapp1.Adapter.GridRecyclerAdapter;
...
//public static HomeFragment mainActivity;
    ...
    private List<String> listIdRoomAccepted;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        listIdRoomAccepted = new ArrayList<>();
        ...
        mAccept.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot childRooms:dataSnapshot.getChildren())
                {
                    ...
                    if(acceptRoom == true)
                    {
                        String idRoomsAccepted = childRooms.getKey();
                        listIdRoomAccepted.add(idRoomsAccepted);
                    }
                }
            }
        ...
        mQuerySelectNewRoom.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot roomSnapshot : dataSnapshot.getChildren()){
                    for (int i=0;i<listIdRoomAccepted.size();i++)
                    {
                        if(roomSnapshot.getKey() == listIdRoomAccepted.get(i))
                        {
